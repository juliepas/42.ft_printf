...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/10 18:16:10 by jpascal           #+#    #+#             */
/*   Updated: 2017/08/10 18:16:11 by jpascal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ajout_attributs_gauche(t_conv **tamp, char *arg, int *i,
	int *j);
void				ajout_attributs_droite(t_conv **tamp, char *arg, int *i,
	int *j);
void				print_str(char **finalstr, t_conv **tamp, char *format,
	int i);
char				*conversion_grand_c(t_conv **tamp, wchar_t argument);
void				deletechaine(t_conv **tamp);
